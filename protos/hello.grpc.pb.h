 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void sayHello(::grpc::ClientContext* context, ::hellostreamingworld::HelloRequest* request, ::grpc::ClientReadReactor< ::hellostreamingworld::HelloReply>* reactor) = 0;
      #else
  ...
  class Stub final : public StubInterface {
   public:
    ...
    class experimental_async final :
     ...
     public:
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void sayHello(::grpc::ClientContext* context, ::hellostreamingworld::HelloRequest* request, ::grpc::ClientReadReactor< ::hellostreamingworld::HelloReply>* reactor) override;
      #else
  ...
  class ExperimentalWithCallbackMethod_sayHello : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_sayHello() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(0,
          new ::grpc_impl::internal::CallbackServerStreamingHandler< ::hellostreamingworld::HelloRequest, ::hellostreamingworld::HelloReply>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    #endif
                     context, const ::hellostreamingworld::HelloRequest* request) { return this->sayHello(context, request); }));
    }
    ...
    virtual ::grpc::ServerWriteReactor< ::hellostreamingworld::HelloReply>* sayHello(
      ::grpc::CallbackServerContext* /*context*/, const ::hellostreamingworld::HelloRequest* /*request*/)
    #else
    virtual ::grpc::experimental::ServerWriteReactor< ::hellostreamingworld::HelloReply>* sayHello(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::hellostreamingworld::HelloRequest* /*request*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  ...
  class ExperimentalWithRawCallbackMethod_sayHello : public BaseClass {
   ...
   public:
        ...
        MarkMethodRawCallback(0,
          new ::grpc_impl::internal::CallbackServerStreamingHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const::grpc::ByteBuffer* request) { return this->sayHello(context, request); }));
    }
    ...
    #else
    virtual ::grpc::experimental::ServerWriteReactor< ::grpc::ByteBuffer>* sayHello(
